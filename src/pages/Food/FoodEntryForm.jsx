...
export function FoodEntryForm({ initialMealType = 'breakfast', profileId, onSave, onCancel }) {
  ...
  return (
    <>
      {/* Overlay fullscreen cuando hay resultado de IA */}
      {showResultCard && (
        <div className="fixed inset-0 z-50 flex flex-col bg-black">
          ...
          <div className="relative flex-shrink-0" style={{ height: '50vh' }}>
            ...
            <button
              type="button"
              onClick={onCancel}
              className="absolute top-4 left-4 w-9 h-9 flex items-center justify-center bg-black/50 rounded-full text-white text-lg leading-none"
            >
              ✕
            </button>
          </div>
          ...
          {/* Bottom sheet blanco */}
          <div className="flex-1 bg-white dark:bg-gray-900 rounded-t-3xl -mt-6 overflow-y-auto px-5 pt-6 pb-8">
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              <button
                ...
                className="w-full py-3.5 bg-primary-600 text-white rounded-2xl font-bold disabled:opacity-40 hover:bg-primary-700 transition-colors text-base shadow-lg shadow-primary-600/30"
              >
